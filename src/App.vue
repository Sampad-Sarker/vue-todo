  ...
  <div class="app-container">
    ...
    <div class="composer">
      ...
      <div class="filter">
        ...
        <Filter
          :todos="todos"
          @allTasks="filteredTasks = 'all'"
          @pendingTasks="filteredTasks = 'pending'"
          @doneTasks="filteredTasks = 'done'"
    ...
    <div class="todos">
      ...
      <div>
        <!-- <p class="app-footer">
          developed by
          <span
            ><a href="https://github.com/Sampad-Sarker">SampadSarker</a></span
          >
          with <span class="animate-pulse">❤️</span>
        </p> -->
...
export default {
  ...
  computed: {
    filteredTodos() {
      ...
      else if (this.filteredTasks == "done")
        return this.todos.filter((el) => el.done);
      else if (this.filteredTasks == "pending")
        return this.todos.filter((el) => !el.done);
    },

    pendingTask() {
      let pendingTask = this.todos.filter((el) => {
        return !el.done;
      });
    ...
    doneTask() {
      let doneTask = this.todos.filter((el) => {
        return el.done;
      });
